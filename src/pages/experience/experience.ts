...
export class ExperiencePage {
  ...
  items = [
    ...
    {
      title: 'Wanek Company â€“ US Company - 1 year located in Binh Duong City, VN',
    ...
    },
    {
      ...
      content: `Develop web and applications on web, phone, tabletâ€¦ base on Adobe Flex 4.5.
      ...
      Our customer majors in producing bags for Nike, Adidas, Mammut,â€¦ So they need to show how to make bag step by step and How much it costs by calculating from the data in their ERP system.
